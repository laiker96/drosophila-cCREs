...
compression complete.  In the default \texttt{--backend auto} mode, runs whose
direct ENA FASTQs fail transfer or integrity validation are converted with SRA
Toolkit; ENA files from other runs that completed successfully remain in
place.  Explicit \texttt{--backend ena} mode disables this failover.  The
